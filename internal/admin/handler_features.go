...
func featureDefinitions() []featureDefinition {
	return []featureDefinition{
		...
		{key: "exact_cache", label: "Exact response cache", category: "performance", endpoint: "/admin/api/v1/cache/overview", offBehavior: "Gateway skips the cache and calls providers directly."},
