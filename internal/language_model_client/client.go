...
// responseBufferPool pools *bytes.Buffer for reading HTTP response bodies,
// reducing allocation pressure under high-throughput proxy workloads.
...
// cloneBytes returns a copy of b. It differs from slices.Clone in that it
// always allocates a new backing array so the returned slice is independent
// of any pooled buffer's internal storage.
