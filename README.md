...
Aurora supports routing through the OpenCode Zen API (`opencode.ai/zen/v1`) using `vLLM` provider type with multi-IP rotation and session hub header mapping.
