#!/bin/sh
# Container entrypoint: start the OpenCode sidecar (Bun) and, when configured,
...
# (e.g. "193.23.210.27,193.23.197.41"). The entrypoint starts an Aurora
# bind-proxy for each on ports 8981+ and points the sidecar at them so OpenCode
