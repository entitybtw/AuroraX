    ...
    <div className="flex items-start gap-3 rounded-lg border border-amber-500/30 bg-amber-500/5 p-4">
      ...
      <div className="text-sm">
        ...
        <p className="text-muted-foreground mt-1 leading-snug">
          The sidecar emulates the OpenCode client fingerprint to reach the free tier.
      ...
      <DialogContent className="max-w-lg mx-4 sm:mx-auto max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle className="flex items-center gap-2">
            ...
            Add OpenCode header rules?
          </DialogTitle>
          <DialogDescription>
            The sidecar replicates the OpenCode client fingerprint. The Session Hub must send
        ...
        {!result ? (
          <div className="flex flex-col gap-3 text-sm">
            <p className="text-muted-foreground">
              This will add the following rules to each OpenCode provider. Existing rules are
      ...
      <Surface id="sidecar-overview" className="p-4 sm:p-6 scroll-mt-20">
        <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
          <div className="flex items-start gap-3">
            ...
            <div>
              <h3 className="text-base font-semibold">OpenCode Sidecar</h3>
              <p className="text-sm text-muted-foreground mt-1">
                Bun-based TLS proxy for OpenCode free-tier access. Works for both Zen and
        ...
        <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground mt-1">
                OpenCode providers need matching <code className="rounded bg-muted px-1 py-0.5 text-xs">x-opencode-*</code>{" "}
      ...
      <Surface id="sidecar-core" className="p-4 sm:p-6 scroll-mt-20">
        ...
        <div className="mt-6 grid grid-cols-1 gap-4 xl:grid-cols-2">
          <ToggleField
            ...
            description="Route OpenCode traffic through the Bun TLS proxy"
          />
          <ToggleField
          ...
          <div className="flex flex-col gap-1.5">
            ...
            />
            <p className="text-xs text-muted-foreground">OpenCode API base URL (Zen or go)</p>
          </div>
        </div>
      </Surface>
