      ...
      <Surface id="sidecar-overview" className="p-6 scroll-mt-20">
        <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
          <div className="flex items-start gap-3">
            ...
            <div>
              <h3 className="text-base font-semibold">free tier Sidecar</h3>
              <p className="text-sm text-muted-foreground mt-1">
                Bun-based TLS proxy for free-tier free-tier access. Requires Bun runtime.
              </p>
            </div>
          </div>
      ...
      <Surface id="sidecar-core" className="p-6 scroll-mt-20">
        ...
        <div className="mt-6 grid grid-cols-1 gap-4 xl:grid-cols-2">
          ...
          <div className="flex flex-col gap-1.5">
            ...
            />
            <p className="text-xs text-muted-foreground">free tier API base URL</p>
          </div>
        </div>
      </Surface>
