...
export const SIDECAR_PRESETS: SidecarPreset[] = [
  {
    ...
    tagline: "Zen and opencode-go free models",
    description:
      "Emulates the OpenCode CLI fingerprint (Bun TLS + full tool schema) and installs the matching x-opencode-* Session Hub headers. The free tier requires the session to be exactly 26 hex characters.",
    sidecar: {
      enabled: true,
      inject_tools: true,
    ...
    summary: [
      ...
      { label: "Tool injection", value: "Full OpenCode tool schema" },
