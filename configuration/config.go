...
type RawProviderConfig struct {
	...
	// Defaults to "https://opencode.ai/console" for OpenCode Zen.
	...
	// Useful for bypassing JA3-based TLS fingerprinting (e.g. OpenCode Zen).
	UseUTLS bool `yaml:"use_utls,omitempty"`
	// SidecarURL routes requests through a local OpenCode Zen sidecar (Bun)
