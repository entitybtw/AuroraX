...
- [DEPLOYMENT.md](DEPLOYMENT.md) — production Docker, persistent state, multi-IP host networking, OpenCode sidecar image.
...
- **OpenCode free tier** — use the `runtime-sidecar` image variant + **Settings → Sidecar** (see the README's **OpenCode Sidecar** section; use at your own risk).
