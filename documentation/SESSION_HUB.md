...
| `map_or_generate` | Like `map`, but when the inbound header is absent a fresh value is generated instead of being skipped. Ideal for clients like the the CLI that only sometimes send a session header. |
